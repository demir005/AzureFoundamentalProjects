...
namespace RedisCache.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            {
                //cached
                categoriesList = JsonConvert.DeserializeObject<List<Category>>(cachedCategory);
            }
            else
            {
                ...
                _cache.SetString("categoryList",JsonConvert.SerializeObject(categoriesList),options);
            }
